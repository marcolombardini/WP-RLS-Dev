...
function wprls_settings_init(  ) { 
	...
	add_settings_field( 
		'wprls_firm_name', 
		__( 'Brokerage or Firm Name', 'wprls' ), 
...
function wprls_settings_section_callback(  ) { 
	...
	echo __( 'When syndicating feeds to aggregators you will need, for some, basic information about your brokerage or firm. A few require that you have a Broker or Firm ID, others let you create your own. If you already have a ID, use that as your default', 'wprls' );
