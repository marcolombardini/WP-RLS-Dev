...
function do_feed_zillow() {
	load_template( ABSPATH . '/wp-content/plugins/wprls_dev/zillow-template.php' );
}
function do_feed_streeteasy() {
	load_template( ABSPATH . '/wp-content/plugins/wprls_dev/streeteasy-template.php' );
}
function do_feed_hotpads() {
	load_template( ABSPATH . '/wp-content/plugins/wprls_dev/hotpads-template.php' );
}
function do_feed_padlister() {
	load_template( ABSPATH . '/wp-content/plugins/wprls_dev/padlister-template.php' );
}
